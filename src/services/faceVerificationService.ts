...
export const verifyFace = async (
  ...
  if (serviceEnabled && serviceUrl) {
    try {
      ...
      if (!profileRes.ok) throw new Error('Failed to fetch profile photo');
...
export const detectFace = async (photoBuffer: Buffer | undefined): Promise<FaceDetectionResult> => {
