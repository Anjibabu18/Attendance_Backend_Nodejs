...
router.get('/scheduled-pushes', adminController.listScheduledPushes);
router.post('/scheduled-pushes', adminController.createScheduledPush);
router.put('/scheduled-pushes/:id', adminController.updateScheduledPush);
router.delete('/scheduled-pushes/:id', adminController.deleteScheduledPush);
